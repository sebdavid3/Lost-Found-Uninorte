...
const claim_factory_provider_1 = require("../application/factories/claim-factory.provider");
const common_claim_factory_1 = require("../application/factories/common-claim.factory");
const electronic_claim_factory_1 = require("../application/factories/electronic-claim.factory");
const claims_service_proxy_1 = require("./controllers/claims.service.proxy");
