...
import { Claim, ClaimStatus, Evidence } from '@prisma/client';
import { ObjectCategory, Role } from '../../domain/enums';
...
type SimpleObject = { id: string; name: string; description: string; category: ObjectCategory; location: string; foundAt: Date; photo: string | null };
