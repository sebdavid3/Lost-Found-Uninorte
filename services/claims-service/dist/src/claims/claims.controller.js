...
const availability_handler_1 = require("./handlers/availability.handler");
const evidence_match_handler_1 = require("./handlers/evidence-match.handler");
const claim_verification_exception_1 = require("./handlers/claim-verification.exception");
const claim_element_1 = require("./visitors/elements/claim.element");
const audit_visitor_1 = require("./visitors/audit.visitor");
const text_similarity_visitor_1 = require("./visitors/text-similarity.visitor");
let ClaimsController = class ClaimsController {
    claimsService;
    claimsServiceProxy;
    prisma;
    constructor(claimsService, claimsServiceProxy, prisma) {
