# Tablero de Avance - Entrega 1

Ultima actualizacion: 2026-04-05
Coordinador de la entrega: TBD
...
## Seguimiento por seccion

| Seccion | Responsable | Estado | Fecha objetivo | Evidencia minima |
| :--- | :--- | :--- | :--- | :--- |
| 6.1 Contexto del problema | TBD | LISTO PARA REVISION | TBD | Documento completo y justificado |
...
- Revision cruzada: cada seccion debe ser revisada por al menos 1 integrante distinto al autor.
- Cierre semanal: actualizar este tablero al finalizar cada sesion de trabajo.
